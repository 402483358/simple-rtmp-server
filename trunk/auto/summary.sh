...
echo -e "     \${BLACK}+------------------------------------------------------------------------------------\${BLACK}"
echo -e "     |${SrsGperfSummaryColor}gperf @see: "
echo -e "     |     ${SrsGperfMCSummaryColor}gmc @see: "
...
echo -e "     |     ${SrsGperfMPSummaryColor}gmp @see: "
...
echo -e "     |     ${SrsGperfCPSummaryColor}gcp @see: "
...
echo -e "     \${BLACK}+------------------------------------------------------------------------------------\${BLACK}"
echo -e "     |${SrsGprofSummaryColor}gprof @see: "
echo -e "     |${SrsGprofSummaryColor}gprof: GNU profile tool, @see: "
...
echo -e "     \${BLACK}+------------------------------------------------------------------------------------\${BLACK}"
echo -e "     |${SrsLibrtmpSummaryColor}librtmp @see: "
